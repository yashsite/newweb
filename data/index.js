...
export const SliderOneData = [
  {
    image: sliderOne01,
    subTitle: "WELCOME TO Tantumsoft AGENCY",
    title: "SMART WEB \n DESIGN AGENCY.",
    button: {
      label: "DISCOVER MORE",
      url: "/about"
...
export const ServiceHomeTwoData = {
  subTitle: "welcome to smart Tantumsoft web agency",
...
export const AboutOneData = {
  sectionContent: {
    title: "build better website alot quicker with Tantumsoft agency",
...
export const AboutTwoData = {
  sectionContent: {
    ...
    subTitle: "welcom to smart Tantumsoft web agency",
    text:
